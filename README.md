...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-06 10:04`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/dcaa5636-256c-4531-a7ed-22a41f0b5d85.git
$ cd dcaa5636-256c-4531-a7ed-22a41f0b5d85
```
